...
IOManager::IOManager(Menu menus[], int availableMenusCount, int currentMenu) : _currentMenuId(0), _availableMenusCount(availableMenusCount),
																			   _menus(menus)
{
	GoToMenu(currentMenu);
}

const Menu &IOManager::CurrentMenu() const
{
